...
func _initialize() -> void:
    ...
    _assert_true(CombatMath.true_wizard_phase(981,1400,0)==1,"True Wizard stays in phase one above Crown Seal threshold")
    _assert_true(CombatMath.true_wizard_phase(532,1400,0)==3,"True Wizard Roads Return threshold")
    _assert_true(CombatMath.true_wizard_phase(533,1400,0)==2,"True Wizard stays in phase two above Roads Return threshold")
    _assert_true(CombatMath.true_wizard_phase(196,1400,0)==4,"True Wizard Mortal Spell threshold")
    _assert_true(CombatMath.true_wizard_phase(197,1400,0)==3,"True Wizard stays in phase three above Mortal Spell threshold")
