...
(() => {
  ...
  dialog.innerHTML = `
    ...
    <div class="key-guide"><strong>Handheld console</strong><p>Left stick or ← / → moves. ↓ crouches. ATTACK performs the light attack, JUMP jumps, HEAVY performs the heavy attack, DASH evades, ABILITY 1 / 2 use class skills, ULTIMATE uses the full-resource special, and INTERACT advances dialogue or activates objects. Multiple controls can be held at the same time.</p><strong>Desktop keyboard &amp; mouse</strong><p>A / D or ← / → move · S / Q crouch · W / E jump · Space / J / left click attack · K or right click heavy · Shift dash · F interact · L / I abilities · U ultimate · Esc pause.</p><strong>Xbox-compatible controller on PC / large screen</strong><p>Left stick or D-pad moves · down crouches · right stick aims · A jumps · B dashes · X attacks · Y heavy attacks · LB / RB use abilities · LT interacts · RT uses the ultimate · View/Back and left-stick click remain backup shortcuts · Menu/Start pauses. The generated handheld console stays hidden on desktop and TV-style layouts.</p></div>
  `;
